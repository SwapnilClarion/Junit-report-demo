...
describe('Validate sorting options in Sale PLP for Guest/Logged-Out,Logged-In User', () => {
  let langArr: any = [];
  let sortLnkTxt: any = [];
  let lnkDataStatus: boolean;
  it('Should populate the language array', () => {
    logger.info('==============Sale PLP==========');
  ...
  it('Should go to sale PLP and verify the sorting options', () => {
