...
describe('Validate user is able to see sale sproduct listed in ascending order after clicking on Low to High', () => {
  ...
  it('Should list all the sale products in ascending order based on current active price', () => {
    logger.info(
      '============= Guest/Logged out User Scenario ================',
    );
    assert.equal(
      true,
      productListingPage.navigateToPLPAndValidateLowToHighPLPListingOrderForSaleProduct(),
  ...
  it('Should list all the sale products in ascending order based on current active price after login', () => {
