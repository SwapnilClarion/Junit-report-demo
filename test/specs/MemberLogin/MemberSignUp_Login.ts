...
describe('Validate user should be able to perform successful registration and login', () => {
  let userEmail: any = '';
  ...
  it('After successful login, user should land on Account details page ', () => {
    signupMethod.login(userEmail, randomData.USER_PASSWORD);
  });
  it('should land on account details page and verify email id', () => {
    let email: any = '';
