...
describe('Validate a user [Guest/Logged_In] add one more button is Displayed in pdp for Multi-Size product', () => {
  let langArr: any = [];
  ...
  it('should select first/Multi-size product and go to its pdp', () => {
